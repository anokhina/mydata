...
public class VaEntityCombobox<T> extends ComboBox<T> {

    private StringQdslRepositoryDataProvider dataProvider;

    public VaEntityCombobox (Supplier<? extends QuerydslPredicateExecutor<T>> repo, StringPath entityQpath, QuerySortOrder... orders) {
        this (repo,
                ostr -> {
    ...
    public VaEntityCombobox (Supplier<? extends QuerydslPredicateExecutor<T>> repo, Function<Optional<String>, Predicate> filterBuilder, QuerySortOrder... orders) {
    ...
    public VaEntityCombobox<T> allowNull (boolean b) {
